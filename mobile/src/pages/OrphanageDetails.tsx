  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.container}>{orphanage.name}</Text>
        <Text style={styles.description}>Presta assistencia a criancas de 06 a 15 anos que se encontre em situacao de risco e/ou vulnerabilidade social.</Text>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoogleMapRoutes} style={styles.routesContainer}>
              <Text style={styles.routesText}>Ver rotas no Maps</Text>
          </TouchableOpacity>
        </View>
